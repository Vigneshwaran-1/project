  ...
  <section class="py-5">
    <div class="container">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
        ...
        <div class="col">
          <div class="card">
            <img src="p1.jpg" class="card-img-top" alt="Design">
            <div class="card-body">
              <p class="card-text">Rolls Roys</p>
            </div>
          </div>
        </div>
        <!-- Duplicate the card -->
        <div class="col">
          <div class="card">
            <img src="p2.jpg" class="card-img-top" alt="Design">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <img src="p3.jpg" class="card-img-top" alt="Design">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <img src="p4.png" class="card-img-top" alt="Design">
            <div class="card-body">
        ...
        <div class="row-cols-1">
            <div class="card">
              <img src="p5.jpg" class="card-img-top" alt="Design">
              <div class="card-body">
          ...
          <div class="row-cols-1">
            <div class="card">
              <img src="p6.jpg" class="card-img-top" alt="Design">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card">
              <img src="p7.png" class="card-img-top" alt="Design">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card">
              <img src="p8.jpg" class="card-img-top" alt="Design">
              <div class="card-body">
...
~~~
# OUTPUT:
![image](https://github.com/user-attachments/assets/57eaae53-8b22-4cac-89a3-08afa005da6b)
